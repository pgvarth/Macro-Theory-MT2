...
%% Model
%Dynamic backward-looking IS-LM
% Steady state
...
legend('$Y_{t}=Y_{t-1}$','$Y_{t,0}=D_{t,0}$','Equilibrium 0','$Y_{t,1}=D_{t,1}$','Equilibrium 1','Interpreter', 'latex', 'FontSize', 14, 'Location', 'southeast')
title('A Rise in $G$','Interpreter', 'latex', 'FontSize', 14)
