##Single Python document for the first part
##################Business Cycles#########################
##########################################################
import pandas as pd  
import matplotlib.pyplot as plt 
from statsmodels.tsa.filters.hp_filter import hpfilter
###copy your file path for "part_1_data_cleared" excel file
data_uk = pd.read_excel('C:/Users/ilias/OneDrive/Desktop/dynamic_macro_projects/part1/Business_cycles_analysis/data_cleared/GBR_DATA_CLEARED.xlsx')
...
import matplotlib.pyplot as plt
from statsmodels.tsa.filters.hp_filter import hpfilter
###copy your file path for "part_2_data_cleared" excel file
data = pd.read_excel("C:/Users/ilias/OneDrive/Desktop/dynamic_macro_projects/part1/Monetary_aggregates_analysis/REVISED/DATA_REVISED/DATA_MACR0HISTORY_REVISED.xlsx")
time = data['year']
narrow = data['narrowm']
broad = data['money']
stir = data['stir']
...
import matplotlib.pyplot as plt
import numpy as np
###copy your file path for "part_3_data_cleared" excel file
data_sub = pd.read_excel("C:/Users/ilias/OneDrive/Desktop/dynamic_macro_projects/part1/fiscal_sustainability/DATA_CLEARED_VOL2.xlsx")
...
##copy your file path for "subperiod data" excel file
dat_sub = pd.read_excel("C:/Users/ilias/OneDrive/Desktop/dynamic_macro_projects/part1/subperiod data.xlsx")
